...
def informar_clube():
    while True:
        ...
        clube_informado = int(input("1 - Flamengo; 2 - Vasco; 3 - Fluminense; 4 - Botafogo; 5 - Outros: "))
        if 5 >= clube_informado >= 1:
            return clube_informado
...
def entrevistar():
    entrevista = Entrevista(informar_clube(), informar_salario(), informar_cidade())
...
def calcular_pessoas_nascidas_em_niteroi_que_torcem_para_outros():
    quantidade = 0
    for index in outros:
        if index.cidade == 1:
            quantidade += 1
...
def calcular_pessoas_entrevistadas():
...
print("Quantidade de pessoas nascidas em Niterói que não torcem para os times sugeridos =",
      calcular_pessoas_nascidas_em_niteroi_que_torcem_para_outros(),
      sep=" "
)

print("------------------------")
print("Quantidade de pessoas entrevistadas =",
      calcular_pessoas_entrevistadas(),
      sep=" "
)